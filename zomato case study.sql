...
-- 5.Find the number of orders placed by each customers
...
-- 11. Find customers who have never ordered (using SQL SET operators) A-B
...
-- 15.FInd delivery partner compensation using the formula (#deliveries*100 + 10000*avg_rating)
